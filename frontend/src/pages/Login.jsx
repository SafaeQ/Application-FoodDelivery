  ...
  return (
    <>
      <form className="form1" >
        ...
        <input type="email" name="mail" className="form-control-lg"   placeholder="Email" required/></div>
        <div className="form-group d-flex flex-column g-2">
        <label htmlFor="password" className="form-label m-2 h5">Password</label>
        <input type="password" name="psd" className="form-control-lg"  placeholder="Password" required/>
        </div>
